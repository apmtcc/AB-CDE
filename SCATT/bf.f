...
c J2: the orbital rotation of E to CD
c J23: the coupling of J2 and J3
c J123: the coupling of J1 and J23
c=================================================================
        subroutine BASCOUP
     ...
     .  NAp, KBZmax, NKBZ  
        ...
        use TRANSMATS, only : KBZ, JJ1, JJ2, JJ3, JJ23, JJ123, TABJJ
...
!       allocate(TABJJ(0:J3max,0:J2max,0:J23max,0:J1max,0:J123max,
!     .    0:KBZmax), stat=ierr)
        NBASJJ=0
...
c==================================================================
        ...
        use COMPARAS, only : NBASJJ, KB1max, KM2max, J1max, J2max, 
     .    J3max, J23max
        implicit none
...
c==================================================================
        subroutine A1BASIS
        use COMPARAS, only : J1max, JD1, NA1node, NSYM, A10
...
c==================================================================
        subroutine A3BASIS
        use COMPARAS, only : J3max, JD3, NA3node, NSYM, A30
